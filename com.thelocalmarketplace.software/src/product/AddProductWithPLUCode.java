...
public class AddProductWithPLUCode extends AbstractProductAdder {		
	public void addProduct(PLUCodedProduct p) {
		//TODO: change the expected weight to the actual weight, not zero
		notifyListeners(p, p.getDescription());
	}
}
