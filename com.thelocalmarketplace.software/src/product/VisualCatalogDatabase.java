...
public class VisualCatalogDatabase {

	private final static HashSet<VisualProductInfo> database = new HashSet<VisualProductInfo>();
	
	public static void addProduct(Product p, String url, String name) 
	{
		VisualProductInfo product = new VisualProductInfo(p, url, name);
		database.add(product);	
	}
	
	
	public static VisualProductInfo[] getAllProducts()
	{
		return database.toArray(new VisualProductInfo[0]);
	}
}
